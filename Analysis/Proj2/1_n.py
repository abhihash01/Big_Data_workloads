...
all_mapped_data = comm.gather(mapped_data, root=0) if rank < num_mappers else None
...
all_reduced_results = comm.gather(reduced_results, root=0) if rank < num_reducers else None
